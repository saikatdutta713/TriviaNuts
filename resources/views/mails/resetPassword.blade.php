  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          We received a request to reset your password for your TriviaNuts
          account.
        </p>
        <p>To reset your password, please click the button below:</p>
        <a href="[Password Reset Link]" class="reset-link">Reset Password</a>
        <p>
          If you didn't request a password reset or believe this email was sent
          in error, you can safely ignore it.
        </p>
        <p>Thank you for using TriviaNuts!</p>
        <p>Sincerely,</p>
        <p>The TriviaNuts Team</p>
      </div>
    </div>
  </body>
</html>
