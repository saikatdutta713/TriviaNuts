...
/***/ "./resources/scss/quiz_result.scss":
/*!*****************************************!*\
  !*** ./resources/scss/quiz_result.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/scss/admin/settings.scss":
/*!********************************************!*\
  !*** ./resources/scss/admin/settings.scss ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener("DOMContentLoaded", function () {
  var notificationBell = document.getElementById("Icon");
  var notificationDesign = document.getElementById("notifications-container");
  var notificationClose = document.getElementById("closeIcon");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var editRulesButton = document.querySelectorAll("#quiz");
  var editModal = document.getElementById("rules-Modal");
  editRulesButton.forEach(function (button) {
    button.addEventListener("click", function () {
      editModal.style.display = "block";
    });
  });
  var closeEditModalBtn = document.getElementById("closeRulesModalBtn");
  closeEditModalBtn.addEventListener("click", function () {
    editModal.style.display = "none";
  });
  window.addEventListener("click", function (event) {
...
/******/ 	__webpack_require__.O(undefined, ["css/app","css/admin","css/home","css/quiz"], () => (__webpack_require__("./resources/scss/quiz_result.scss")))
